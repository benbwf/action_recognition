...
def vid2jpg(file_name, class_path, dst_class_path):
    ...
    try:
        if os.path.exists(dst_directory_path):
            print('dst_directory_path', dst_directory_path)
    ...
    # Messing around
    cmd = 'ffmpeg -i \"{}\" -threads 1 -vf scale=-1:331 -q:v 0 \"{}/img_%05d.jpg\" -vsync 0'.format(video_file_path, dst_directory_path)
...
def convert_folder(dir_path, dst_dir_path):
    class_path = dir_path
...
"""
converts all videos in dir_path and save as images into folders in dst_dir_path
"""
if __name__ == "__main__":
    dir_path = sys.argv[1]
    dst_dir_path = sys.argv[2]
    convert_folder(dir_path, dst_dir_path)
